 ...
 * @package Wikipedia
 */
class Wikipedia extends Actions
{
	/**
	 * @const array
	 */
	...
	public static function search1($q,$e){
         $a = new Wikipedia\Wikipedia($q,$e);
         return $a->search();
     
}

    public static function wiki($channel, $nickname, $args) {
    if(!($args)) {
    return "Pencyaryan Wyky By Syandal_ .. argumen harus dimasukin .. "; }
    else {
    $stringargumen = implode(" ", $args);
    $hasilwiki = new Wikipedia($stringargumen, "id");
    return $hasilwiki->search();
