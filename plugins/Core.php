...
class Core extends Actions {
	...
	public static function help($channel, $nickname, $args) {
		...
		$help[] = "\x02!wiki\x02 #channel kata pencarian";
		$help[] = "\x02!google\x02 kata pencarian";
		$help[] = "\x02!pengumuman\x02 #channel sqlite|python|linux";
		$help[] = "\x02!salam\x02 #channel ";
		$help[] = "\x02!wasalam\x02 #channel #nickname";
    ...
    public static function ituan($channel, $nickname, $args) {
        $toChan = $args[0];
